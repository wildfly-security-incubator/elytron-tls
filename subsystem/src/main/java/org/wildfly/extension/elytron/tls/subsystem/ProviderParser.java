...
import static org.wildfly.extension.elytron.tls.subsystem.Constants.AGGREGATE_PROVIDERS;
import static org.wildfly.extension.elytron.tls.subsystem.Constants.PROVIDERS;
import static org.wildfly.extension.elytron.tls.subsystem.Constants.PROVIDER_LOADER;
...
class ProviderParser {
    ...
    final PersistentResourceXMLDescription providerParser_1_0 = /*PersistentResourceXMLDescription.builder(PathElement.pathElement(Constants.PROVIDERS))
            .setXmlWrapperElement(PROVIDERS)*/ PersistentResourceXMLDescription.decorator(PROVIDERS)
