...
abstract class AbstractCredentialStoreResourceDefinition extends SimpleResourceDefinition {
    ...
    static final ServiceUtil<CredentialStore> CREDENTIAL_STORE_UTIL = ServiceUtil.newInstance(CREDENTIAL_STORE_RUNTIME_CAPABILITY, Constants.CREDENTIAL_STORE, CredentialStore.class);
