...
class AggregateComponentDefinition<T> extends SimpleResourceDefinition {
    ...
    private AggregateComponentDefinition(Class<T> classType, String pathKey, OperationStepHandler addHandler, OperationStepHandler removeHandler,
        ...
        super(new Parameters(PathElement.pathElement(pathKey), ElytronTlsExtension.getResourceDescriptionResolver(pathKey))
    ...
    /**
     * @see SimpleResourceDefinition#registerAttributes(ManagementResourceRegistration)
     */
    @Override
    ...
    static <T> AggregateComponentDefinition<T> create(Class<T> aggregationType, String componentName, String referencesName,
        ...
        AbstractAddStepHandler add = new AggregateComponentAddHandler<>(aggregationType, aggregator, aggregateReferences, runtimeCapability, dependOnProviderRegistration);
        ...
        return new AggregateComponentDefinition<>(aggregationType, componentName, add, remove, aggregateReferences, write, runtimeCapability);
    }
    ...
    static <T> AggregateComponentDefinition<T> create(Class<T> aggregationType, String componentName, String referencesName,
        ...
        AbstractAddStepHandler add = new AggregateApiComponentAddHandler<>(aggregationType, aggregator, aggregateReferences, runtimeCapability, apiCapabilityName, dependOnProviderRegistration);
        OperationStepHandler remove = new TrivialCapabilityServiceRemoveHandler(add, runtimeCapability);
        OperationStepHandler write = new ElytronReloadRequiredWriteAttributeHandler(aggregateReferences);
    ...
    private static class AggregateComponentAddHandler<T> extends BaseAddHandler {
        ...
        protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model)
            ...
            AggregateComponentService<T> aggregateComponentService = new AggregateComponentService<>(aggregationType, aggregator);
