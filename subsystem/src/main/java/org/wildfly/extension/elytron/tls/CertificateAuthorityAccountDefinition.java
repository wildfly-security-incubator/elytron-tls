...
import static org.wildfly.extension.elytron.tls.AdvancedModifiableKeyStoreDecorator.resetAcmeAccount;
...
import static org.wildfly.extension.elytron.tls.Capabilities.CERTIFICATE_AUTHORITY_CAPABILITY;
import static org.wildfly.extension.elytron.tls.Capabilities.CERTIFICATE_AUTHORITY_RUNTIME_CAPABILITY;
...
import static org.wildfly.extension.elytron.tls.ElytronTlsSubsystemDefinition.commonRequirements;
...
class CertificateAuthorityAccountDefinition extends SimpleResourceDefinition {
    ...
    static final SimpleAttributeDefinition CERTIFICATE_AUTHORITY = new CertificateAuthorityDefinitionBuilder(Constants.CERTIFICATE_AUTHORITY, ModelType.STRING, true)
    ...
    static final ObjectTypeAttributeDefinition KEY_STORE_OBJECT = new ObjectTypeAttributeDefinition.Builder(Constants.KEY_STORE_OBJECT, SSLContextDefinitions.TYPE,
                PATH, RELATIVE_TO, SSLContextDefinitions.REQUIRED, SSLContextDefinitions.CREDENTIAL_REFERENCE,
                SSLContextDefinitions.ALIAS_FILTER, KeyStoreDefinition.PROVIDER_NAME, KeyStoreDefinition.PROVIDERS)
            .setAttributeGroup(Constants.ACCOUNT_KEY)
            .setMinSize(1)
    ...
    private static class CertificateAuthorityAccountAddHandler extends BaseAddHandler {
        ...
        protected void performRuntime(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
            ...
            if (keyStoreName == null) {
                ...
                keyStoreName = keyStoreObject.asStringOrNull();
            } else {
                if (keyStoreObject != null) {
    ...
    CertificateAuthorityAccountDefinition() {
        super(new Parameters(PathElement.pathElement(Constants.CERTIFICATE_AUTHORITY_ACCOUNT), ElytronTlsExtension.getResourceDescriptionResolver(Constants.CERTIFICATE_AUTHORITY_ACCOUNT))
                .setAddHandler(ADD)
    ...
    public void registerOperations(ManagementResourceRegistration resourceRegistration) {
        ...
        ResourceDescriptionResolver resolver = ElytronTlsExtension.getResourceDescriptionResolver(Constants.CERTIFICATE_AUTHORITY_ACCOUNT);
    ...
    static class CreateAccountHandler extends ElytronRuntimeOnlyHandler {
        ...
        static void register(ManagementResourceRegistration resourceRegistration, ResourceDescriptionResolver descriptionResolver) {
            resourceRegistration.registerOperationHandler(
                    new SimpleOperationDefinitionBuilder(Constants.CREATE_ACCOUNT, descriptionResolver)
        ...
        protected void executeRuntimeStep(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            try {
                ...
                if (! created) {
                    throw LOGGER.certificateAuthorityAccountAlreadyExists(Constants.UPDATE_ACCOUNT, Constants.CHANGE_ACCOUNT_KEY);
                }
            } catch (AcmeException e) {
                throw LOGGER.unableToCreateAccountWithCertificateAuthority(e, e.getLocalizedMessage());
            }
        }
    }

    static class UpdateAccountHandler extends ElytronRuntimeOnlyHandler {
        static final SimpleAttributeDefinition UPDATE_AGREE_TO_TERMS_OF_SERVICE = new SimpleAttributeDefinitionBuilder(Constants.AGREE_TO_TERMS_OF_SERVICE, ModelType.BOOLEAN, true)
                .setAllowExpression(true)
                .build();

        static void register(ManagementResourceRegistration resourceRegistration, ResourceDescriptionResolver descriptionResolver) {
            resourceRegistration.registerOperationHandler(
                    new SimpleOperationDefinitionBuilder(Constants.UPDATE_ACCOUNT, descriptionResolver)
                            .setParameters(AGREE_TO_TERMS_OF_SERVICE, STAGING)
                            .setRuntimeOnly()
                            .build(),
        ...
        protected void executeRuntimeStep(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            try {
                ...
                throw LOGGER.unableToUpdateAccountWithCertificateAuthority(e, e.getLocalizedMessage());
            }
        }
    }
    ...
    static class ChangeAccountKeyHandler extends ElytronRuntimeOnlyHandler {
        ...
        static void register(ManagementResourceRegistration resourceRegistration, ResourceDescriptionResolver descriptionResolver) {
            resourceRegistration.registerOperationHandler(
                    new SimpleOperationDefinitionBuilder(Constants.CHANGE_ACCOUNT_KEY, descriptionResolver)
        ...
        protected void executeRuntimeStep(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            try {
                ...
                throw LOGGER.unableToChangeAccountKeyWithCertificateAuthority(e, e.getLocalizedMessage());
            }
        }
    }
    ...
    static class DeactivateAccountHandler extends ElytronRuntimeOnlyHandler {
        ...
        static void register(ManagementResourceRegistration resourceRegistration, ResourceDescriptionResolver descriptionResolver) {
            resourceRegistration.registerOperationHandler(
                    new SimpleOperationDefinitionBuilder(Constants.DEACTIVATE_ACCOUNT, descriptionResolver)
                            .setParameters(STAGING)
                            .setRuntimeOnly()
                            .build(),
        ...
        protected void executeRuntimeStep(final OperationContext context, final ModelNode operation) throws OperationFailedException {
            ...
            try {
                ...
                throw LOGGER.unableToDeactivateAccountWithCertificateAuthority(e, e.getLocalizedMessage());
            }
        }
    }
    ...
    static class GetMetadataHandler extends ElytronRuntimeOnlyHandler {
        ...
        static void register(ManagementResourceRegistration resourceRegistration, ResourceDescriptionResolver descriptionResolver) {
            resourceRegistration.registerOperationHandler(
                    new SimpleOperationDefinitionBuilder(Constants.GET_METADATA, descriptionResolver)
                            .setParameters(STAGING)
                            .setRuntimeOnly()
                            .build(),
            ...
            try {
                ...
                if (metadata != null) {
                    ...
                    if (metadata.getTermsOfServiceUrl() != null) {
                        result.get(Constants.TERMS_OF_SERVICE).set(new ModelNode(metadata.getTermsOfServiceUrl()));
                    }
                    if (metadata.getWebsiteUrl() != null) {
                        result.get(Constants.WEBSITE).set(new ModelNode(metadata.getWebsiteUrl()));
                    }
                    ...
                    if (caaIdentitiesArray != null && caaIdentitiesArray.length != 0) {
                        ...
                        result.get(Constants.CAA_IDENTITIES).set(caaIdentities);
                    }
                    result.get(Constants.EXTERNAL_ACCOUNT_REQUIRED).set(metadata.isExternalAccountRequired());
                }
            } catch (AcmeException e) {
                throw LOGGER.unableToGetCertificateAuthorityMetadata(e, e.getLocalizedMessage());
            }
        }
    }
