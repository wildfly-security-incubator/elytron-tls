...
class SSLContextResource extends DelegatingResource {
    ...
    public Set<String> getChildTypes() {
        if (hasActiveSessions()) {
            return Collections.singleton(Constants.SSL_SESSION);
        }
    ...
    public boolean hasChildren(String childType) {
        return Constants.SSL_SESSION.equals(childType) && hasActiveSessions();
    }

    @Override
    public boolean hasChild(PathElement element) {
        SSLContext sslContext;
        if (Constants.SSL_SESSION.equals(element.getKey()) && (sslContext = getSSLContext(sslContextServiceController)) != null) {
    ...
    public Set<String> getChildrenNames(String childType) {
        SSLContext sslContext;
        if (Constants.SSL_SESSION.equals(childType) && (sslContext = getSSLContext(sslContextServiceController)) != null) {
            SSLSessionContext sslSessionContext = server ? sslContext.getServerSessionContext() : sslContext.getClientSessionContext();
    ...
    public Set<ResourceEntry> getChildren(String childType) {
        ...
        for (String s : getChildrenNames(childType)) {
            PlaceholderResource.PlaceholderResourceEntry placeholderResourceEntry = new PlaceholderResource.PlaceholderResourceEntry(Constants.SSL_SESSION, s);
