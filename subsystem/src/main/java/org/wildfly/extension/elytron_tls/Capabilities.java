...
import static org.wildfly.extension.elytron_tls.ElytronTlsExtension.BASE_SERVICE_NAME;
...
class Capabilities extends ElytronCommonCapabilities {
    ...
    static final String ELYTRON_TLS_CAPABILITY = CAPABILITY_BASE + "elytron-tls";
